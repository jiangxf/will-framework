 ...
 */
public abstract class AQSingleProcessor extends AQProcessor {

    protected long millis = 1000;

    public AQSingleProcessor(String threadName, AQConsumer aqConsumer) {
    ...
    protected void doRun() {
        ...
        while (true) {
            ...
            // 记录日志
            //LogCollectManager.common("Consumer <> " + aqConsumer.getAction() + " Count: 1", "aq", aqConsumer.getAction());
