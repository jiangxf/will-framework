...
//import org.will.framework.aq.cache.CacheManager;
...
//
//        // 记录日志
//        //LogCollectManager.cache("Consumer <> " + action + " - " + mqRequest.getParams(), "aq", action);
//
//    }
//
//    /**
...
//        CacheManager.getCache().set(getResponseKey(action, requestId), result, timeout);
//    }
//
//    /**
//     * 获取应答
